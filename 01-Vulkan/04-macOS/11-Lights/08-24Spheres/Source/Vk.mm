...
-(void) applicationDidFinishLaunching:(NSNotification *)notification 
{
    ...
    [window setTitle:@"Atharv Natu : macOS : Vulkan 24 Spheres"];
...
-(VkResult) initialize
{
    ...
    //* Generate Sphere
    sphere = new Sphere(1.5f, 128, 128);
...
-(VkResult) createVertexBuffer
{
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For Vertex Position Buffer : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For Vertex Normals Buffer : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
...
-(VkResult) createIndexBuffer
{
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For Index Buffer : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
