...
-(void) applicationDidFinishLaunching:(NSNotification *)notification 
{
    ...
    [window setTitle:@"Atharv Natu : macOS : Vulkan Checkerboard Texture"];
...
-(VkResult) initialize
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s() => createTexture() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        fprintf(gpFile, "%s() => createTexture() Succeeded\n", __func__);
...
-(void) uninitialize
{
    ...
    if (vkDescriptorPool)
    {
        ...
        fprintf(gpFile, "%s() => vkDestroyDescriptorPool() => Destroyed vkDescriptorPool and vkDescriptorSet_straight Successfully\n", __func__);
    }
...
-(VkResult) createVertexBuffer
{
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For Vertex Texcoord Buffer : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
...
-(VkResult) createUniformBuffer
{
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For uniformData_straight : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For uniformData_oblique : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
