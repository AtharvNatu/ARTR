...
-(void) applicationDidFinishLaunching:(NSNotification *)notification 
{
    ...
    [window setTitle:@"Atharv Natu : macOS : Vulkan Texture On Pyramid And Cube"];
...
-(VkResult) createVertexBuffer
{
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For Vertex Position Buffer For Pyramid : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For Vertex Texcoord Buffer For Pyramid : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For Vertex Texcoord Buffer For Cube : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
...
-(VkResult) createUniformBuffer
{
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For Pyramid : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s() => vkCreateBuffer() Failed For Uniform Data For Cube : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        fprintf(gpFile, "%s() => vkCreateBuffer() Succeeded For Uniform Data For Cube\n", __func__);
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(gpFile, "%s() => Host Visible Memory Not Found For Cube : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
