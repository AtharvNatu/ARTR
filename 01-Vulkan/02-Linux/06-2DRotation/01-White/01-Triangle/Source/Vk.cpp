...
int main(void)
{
    ...
    //* Set Window Caption
    XStoreName(gpDisplay, window, "Atharv Natu : Vulkan 2D Rotation : White Triangle");
...
VkResult updateUniformBuffer(void)
{
    ...
    glm::mat4 rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(fAngle), glm::vec3(0.0f, 1.0f, 0.0f));
