...
int main(void)
{
    ...
    //* Set Window Caption
    XStoreName(gpDisplay, window, "Atharv Natu : Vulkan Tessellation Shaders");
...
VkResult updateUniformBuffer(void)
{
    ...
    char str[255];
    sprintf(str, "Atharv Natu : Vulkan Tessellation Shaders | Number Of Segments = %d", uiNumberOfLineSegments);
