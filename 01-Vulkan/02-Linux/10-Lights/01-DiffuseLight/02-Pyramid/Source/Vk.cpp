...
//? Normals Format and Normals Space
...
int main(void)
{
    ...
    //* Set Window Caption
    XStoreName(gpDisplay, window, "Atharv Natu : Vulkan Diffuse Light On Pyramid");
...
VkResult initialize(void)
{
    ...
    //! Initialize Clear Normals Values (Analogous to glClearColor())
...
VkResult createRenderPass(void)
{
    ...
    //! Normals Attachment (Graphics Pipeline)
