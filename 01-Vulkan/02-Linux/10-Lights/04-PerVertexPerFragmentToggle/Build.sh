...
SPHERE_LIB_PATH="/home/atharv/Desktop/Workspace/ARTR/01-Vulkan/02-Linux/External/Lib"
...
g++ "$BIN_DIR"/Vk.o -o "$BIN_DIR"/Vk \
    -lX11 \
    -lm \
    -L"$VULKAN_LIB_PATH" -lvulkan \
    -L"$SPHERE_LIB_PATH" -lSphere \
    -Wl,-rpath,"$SPHERE_LIB_PATH"
