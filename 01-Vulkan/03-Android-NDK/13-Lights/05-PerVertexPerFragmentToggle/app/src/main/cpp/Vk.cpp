...
VkResult initialize(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createIndexBuffer() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createIndexBuffer() Succeeded\n", __func__);
...
VkResult uninitialize(void)
{
    ...
    if (vertexData_normals.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vertexData_normals.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_normals.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vertexData_normals.vkBuffer\n", __func__);
    }
