...
VkResult uninitialize(void)
{
    ...
    if (vertexData_normal.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vertexData_normal.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_normal.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vertexData_normal.vkBuffer\n", __func__);
    }
...
VkResult createVertexBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
       __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Vertex Normal Buffer : %d !!!\n", __func__, vkResult);
    else
       __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded For Vertex Normal Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
       __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Vertex Normal Buffer : %d !!!\n", __func__, vkResult);
    else
       __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Vertex Normal Buffer\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_normal.vkBuffer, vertexData_normal.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
       __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed For Vertex Normal Buffer : %d !!!\n", __func__, vkResult);
    else
       __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded For Vertex Normal Buffer\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_normal.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
       __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed For Vertex Normal Buffer : %d !!!\n", __func__, vkResult);
    else
       __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Succeeded For Vertex Normal Buffer\n", __func__);
