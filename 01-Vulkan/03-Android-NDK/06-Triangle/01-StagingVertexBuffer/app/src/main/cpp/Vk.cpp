...
VkResult createVertexBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed To Create Staging Vertex Buffer: %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded In Creating Staging Vertex Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed To Allocate Memory For Staging Vertex Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded In Allocating Memory For Staging Vertex Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed To Bind Buffer Memory For Staging Vertex Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded In Binding Buffer Memory For Staging Vertex Buffer\n", __func__);
    ...
    vkResult = vkMapMemory(
     ...
     if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed To Map Memory For Staging Vertex Buffer: %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Succeeded In Mapping Memory For Staging Vertex Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Device-Visible Buffer: %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded In Creating Device-Visible Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed To Allocate Memory For Device-Visible Buffer: %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded In Allocating Memory For Device-Visible Buffer\n", __func__);

    vkResult = vkBindBufferMemory(vkDevice, vertexData_position.vkBuffer, vertexData_position.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed To Bind Buffer Memory For Device-Visible Buffer: %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded In Binding Memory For Device-Visible Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateCommandBuffers() Failed To Allocate Command Buffer For Buffer-Copy: %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateCommandBuffers() Succeeded In Allocating Command Buffer For Buffer-Copy\n", __func__);
    //*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBeginCommandBuffer() Failed For Buffer-Copy: %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkCommandBuffer)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeCommandBuffers() Succeeded For Buffer-Copy\n", __func__);
        }
        if (vertexData_stagingBuffer_position.vkDeviceMemory)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vertexData_stagingBuffer_position.vkDeviceMemory\n", __func__);
        }
        if (vertexData_stagingBuffer_position.vkBuffer)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vertexData_stagingBuffer_position.vkBuffer\n", __func__);
        }

        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBeginCommandBuffer() Succeeded For Buffer-Copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkEndCommandBuffer() Failed For Buffer-Copy: %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkEndCommandBuffer() Succeeded For Buffer-Copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkQueueSubmit() Failed For Buffer-Copy : %d\n", __func__, vkResult);
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkQueueSubmit() Succeeded For Buffer-Copy\n", __func__);

    vkResult = vkQueueWaitIdle(vkQueue);
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkQueueWaitIdle() Failed For Buffer-Copy : %d\n", __func__, vkResult);
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkQueueWaitIdle() Succeeded For Buffer-Copy\n", __func__);
    //*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
