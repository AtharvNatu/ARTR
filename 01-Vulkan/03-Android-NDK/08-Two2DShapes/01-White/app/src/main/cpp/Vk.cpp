...
VkResult createVertexBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Vertex Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded For Vertex Buffer Used For Triangle\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Vertex Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Vertex Buffer Used For Triangle\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed For Vertex Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded For Vertex Buffer Used For Triangle \n", __func__);

    //* Step - 11
    void* data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position_triangle.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed For Vertex Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Succeeded For Vertex Buffer Used For Triangle \n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Vertex Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded For Vertex Buffer Used For Rectangle\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Vertex Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Vertex Buffer Used For Rectangle\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed For Vertex Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded For Vertex Buffer Used For Rectangle \n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position_rectangle.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed For Vertex Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Succeeded For Vertex Buffer Used For Rectangle \n", __func__);
