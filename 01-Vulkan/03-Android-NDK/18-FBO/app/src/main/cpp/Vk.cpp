...
VkResult initialize(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createImagesAndImageViews_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createImagesAndImageViews_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createCommandBuffers() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createCommandBuffer_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createCommandBuffer_fbo() Succeeded\n", __func__);

    //! Create Vertex Buffer
    vkResult = createVertexBuffer();
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createVertexBuffer() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createVertexBuffer() Succeeded\n", __func__);
    ...
    if (pPositions == NULL)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => malloc() Failed For pPositions : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (pNormals == NULL)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => malloc() Failed For pNormals : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (pTexCoords == NULL)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => malloc() Failed For pTexCoords : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (pElements == NULL)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => malloc() Failed For pElements : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createVertexBuffer_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createVertexBuffer_fbo() Succeeded\n", __func__);

    //! Create Index Buffer
    vkResult = createIndexBuffer_fbo();
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createIndexBuffer_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createIndexBuffer_fbo() Succeeded\n", __func__);

    //! Create Texture
    vkResult = createTexture_fbo("Marble.png");
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createTexture() Failed For Marble.png : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createTexture() Succeeded For Marble.png\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createUniformBuffer_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createUniformBuffer_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createShaders_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createDescriptorSetLayout_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createDescriptorSetLayout_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createPipelineLayout_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createPipelineLayout_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createDescriptorPool_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createDescriptorPool_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createDescriptorSet_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createDescriptorSet_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createRenderPass_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createRenderPass_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createPipeline_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createPipeline_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createFramebuffer_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createFramebuffer_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createSemaphore_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createSemaphore_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => buildCommandBuffer_fbo() Failed\n", __func__);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => buildCommandBuffer_fbo() Succeeded\n", __func__);
...
VkResult resize(int width, int height)
{
    ...
    bInitialized = false;
    {
        ...
        if (vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkResetDescriptorPool() Failed\n", __func__);
            return vkResult;
        }
        //?--------------------------------------------------------------------------------------------------
        ...
        if (vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => createDescriptorSet() Failed\n", __func__);
            return vkResult;
        }
...
VkResult display(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkQueueSubmit() Failed For FBO : %d\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => updateUniformBuffer_fbo() Failed : %d\n", __func__, vkResult);
...
VkResult uninitialize(void)
{
    ...
    if (vertexData_texcoord.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vertexData_texcoord.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_texcoord.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vertexData_texcoord.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_position.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vertexData_position.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_position.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vertexData_position.vkBuffer\n", __func__);
    }
    ...
    if (vkCommandBuffer_array)
    {
        ...
        {
            vkFreeCommandBuffers(vkDevice, vkCommandPool, 1, &vkCommandBuffer_array[i]);
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeCommandBuffers() Succeeded For Index : %d\n", __func__, i);
        }

        free(vkCommandBuffer_array);
        vkCommandBuffer_array = NULL;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => free() Succeeded For vkCommandBuffer_array\n", __func__);
    }
...
VkResult createVertexBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Vertex Texture Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded For Vertex Texture Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Vertex Texture Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Vertex Texture Buffer\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoord.vkBuffer, vertexData_texcoord.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed For Vertex Texture Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded For Vertex Texture Buffer\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_texcoord.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed For Vertex Texture Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Succeeded For Vertex Texture Buffer\n", __func__);
...
VkResult buildCommandBuffers(void)
{
    ...
    for (uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        if (vkResult != VK_SUCCESS)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkResetCommandBuffer() Succeeded For Index : %d\n", __func__, i);
        ...
        if (vkResult != VK_SUCCESS)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBeginCommandBuffer() Succeeded For Index : %d\n", __func__, i);
        ...
        if (vkResult != VK_SUCCESS)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkEndCommandBuffer() Succeeded For Index : %d\n", __func__, i);
    }
...
void uninitialize_fbo(void)
{
    ...
    if (vkSemaphore_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroySemaphore() Succeeded For vkSemaphore_fbo\n", __func__);
    ...
    if (vkPipeline_fbo)
    {
        vkDestroyPipeline(vkDevice, vkPipeline_fbo, NULL);
        vkPipeline_fbo = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyPipeline() Succeeded For vkPipeline_fbo\n", __func__);
    }
    ...
    if (vkRenderPass_fbo)
    {
        vkDestroyRenderPass(vkDevice, vkRenderPass_fbo, NULL);
        vkRenderPass_fbo = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyRenderPass() Succeeded For vkRenderPass_fbo\n", __func__);
    }
    ...
    if (vkDescriptorPool_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyDescriptorPool() => Destroyed vkDescriptorPool_fbo and vkDescriptorSet_fbo Successfully\n", __func__);
    }
    ...
    if (vkPipelineLayout_fbo)
    {
        vkDestroyPipelineLayout(vkDevice, vkPipelineLayout_fbo, NULL);
        vkPipelineLayout_fbo = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyPipelineLayout() Succeeded For vkPipelineLayout_fbo\n", __func__);
    }
    ...
    if (vkDescriptorSetLayout_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyDescriptorSetLayout() Succeeded For vkDescriptorSetLayout_fbo\n", __func__);
    }
    ...
    if (vkShaderModule_fragment_shader_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyShaderModule() Succeeded For FBO Fragment Shader\n", __func__);
    }
    ...
    if (vkShaderModule_vertex_shader_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyShaderModule() Succeeded For FBO Vertex Shader\n", __func__);
    }
    ...
    if (uniformData_fbo.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For uniformData_fbo.vkDeviceMemory\n", __func__);
    }
    ...
    if (uniformData_fbo.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For uniformData_fbo.vkBuffer\n", __func__);
    }
    ...
    if (vkSampler_texture_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroySampler() Succeeded For vkSampler_texture_fbo\n", __func__);
    }
    ...
    if (vkImageView_texture_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyImageView() Succeeded For vkImage_texture_fbo\n", __func__);
    }
    ...
    if (vkDeviceMemory_texture_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vkDeviceMemory_texture_fbo\n", __func__);
    }
    ...
    if (vkImage_texture_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyImage() Succeeded For vkImage_texture_fbo\n", __func__);
    }
    ...
    if (vertexData_index_fbo.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vertexData_index_fbo.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_index_fbo.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vertexData_index_fbo.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_texcoords_fbo.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vertexData_texcoords_fbo.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_texcoords_fbo.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vertexData_texcoords_fbo.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_normals_fbo.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vertexData_normals_fbo.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_normals_fbo.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vertexData_normals_fbo.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_position_fbo.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vertexData_position_fbo.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_position_fbo.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vertexData_position_fbo.vkBuffer\n", __func__);
    }
    ...
    if (vkCommandBuffer_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => free() Succeeded For vkCommandBuffer_fbo\n", __func__);
    }
    ...
    if (vkImageView_depth_fbo)
    {
        vkDestroyImageView(vkDevice, vkImageView_depth_fbo, NULL);
        vkImageView_depth_fbo = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyImageView() Succeeded For vkImageView_depth_fbo\n", __func__);
    }
    ...
    if (vkImage_depth_fbo)
    {
        vkDestroyImage(vkDevice, vkImage_depth_fbo, NULL);
        vkImage_depth_fbo = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyImage() Succeeded For vkImage_depth_fbo\n", __func__);
    }
    ...
    if (vkDeviceMemory_depth_fbo)
    {
        vkFreeMemory(vkDevice, vkDeviceMemory_depth_fbo, NULL);
        vkDeviceMemory_depth_fbo = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vkDeviceMemory_depth_fbo\n", __func__);
    }
    ...
    if (vkSampler_fbo)
    {
        vkDestroySampler(vkDevice, vkSampler_fbo, NULL);
        vkSampler_fbo = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroySampler() Succeeded For vkSampler_fbo\n", __func__);
    }
    ...
    if (vkImageView_fbo)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyImageView() Succeeded For vkImageView_fbo\n", __func__);
    }
    ...
    if (vkDeviceMemory_fbo)
    {
        vkFreeMemory(vkDevice, vkDeviceMemory_fbo, NULL);
        vkDeviceMemory_fbo = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vkDeviceMemory_fbo\n", __func__);
    }
    ...
    if (vkImage_fbo)
    {
        vkDestroyImage(vkDevice, vkImage_fbo, NULL);
        vkImage_fbo = NULL;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyImage() Succeeded For vkImage_fbo\n", __func__);
    }
...
VkResult createImagesAndImageViews_fbo(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImage() Failed For FBO Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }     
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImage() Succeeded For FBO Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For FBO Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For FBO Texture\n", __func__);

    vkResult = vkBindImageMemory(vkDevice, vkImage_fbo, vkDeviceMemory_fbo, 0);
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindImageMemory() Failed For FBO Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }      
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindImageMemory() Succeeded For FBO Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImageView() Failed For FBO Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }   
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImageView() Succeeded FBO Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateSampler() Failed For FBO Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }    
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateSampler() Succeeded For FBO Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImage() Failed For FBO Depth Image : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImage() Succeeded For FBO Depth Image\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For FBO Depth : %d !!!\n", __func__, vkResult);
        return vkResult;
    }     
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For FBO Depth\n", __func__);

    vkResult = vkBindImageMemory(vkDevice, vkImage_depth_fbo, vkDeviceMemory_depth_fbo, 0);
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindImageMemory() Failed For FBO Depth : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindImageMemory() Succeeded For FBO Depth\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImageView() Failed For FBO Depth : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImageView() Succeeded For FBO Depth\n", __func__);
...
VkResult createCommandBuffer_fbo(void)
{
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateCommandBuffers() Failed For vkCommandBuffer_fbo: %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateCommandBuffers() Succeeded For vkCommandBuffer_fbo\n", __func__);
...
VkResult createVertexBuffer_fbo(void)
{
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Vertex Normals Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded For Vertex Normals Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Vertex Normals Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Vertex Normals Buffer\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_normals_fbo.vkBuffer, vertexData_normals_fbo.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed For Vertex Normals Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded For Vertex Normals Buffer\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_normals_fbo.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed For Vertex Normals Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Succeeded For Vertex Normals Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Vertex Texcoords Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded For Vertex Texcoords Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Vertex Texcoords Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Vertex Texcoords Buffer\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoords_fbo.vkBuffer, vertexData_texcoords_fbo.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed For Vertex Texcoords Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded For Vertex Texcoords Buffer\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_texcoords_fbo.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed For Vertex Texcoords Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Succeeded For Vertex Texcoords Buffer\n", __func__);
...
VkResult createIndexBuffer_fbo(void)
{
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Index Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded For Index Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Index Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Index Buffer\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_index_fbo.vkBuffer, vertexData_index_fbo.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed For Index Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded For Index Buffer\n", __func__);

    //* Step - 11
    void* data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_index_fbo.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed For Index Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Succeeded For Index Buffer\n", __func__);
...
VkResult createTexture_fbo(const char* textureFileName)
{
    ...
    //! Step - 1
    AAsset *imageAsset = AAssetManager_open(androidAssetManager, textureFileName, AASSET_MODE_BUFFER);
    if (imageAsset == NULL)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => Failed To Open Image : %s !!!", __func__, textureFileName);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }

    size_t imageAssetSize = AAsset_getLength(imageAsset);

    uint8_t* assetData = (uint8_t*)malloc(imageAssetSize * sizeof(char));
    if (assetData == NULL)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => malloc() Failed For assetData !!!\n", __func__);
        return VK_ERROR_OUT_OF_HOST_MEMORY;
    }

    size_t retVal = AAsset_read(imageAsset, assetData, imageAssetSize);
    if (retVal < 0)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => Failed To Read From Image : %s !!!", __func__, textureFileName);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (imageAsset)
    {
        AAsset_close(imageAsset); 
        imageAsset = NULL;
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => Closed Image Asset\n", __func__);
    }

    imageData = stbi_load_from_memory(assetData, imageAssetSize, &imageWidth, &imageHeight, &numChannels, STBI_rgb_alpha);
    if (imageData == NULL || imageWidth <= 0 || imageHeight <= 0 || numChannels <= 0)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => Failed For %s !!!\n", __func__, textureFileName);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    __android_log_print(ANDROID_LOG_INFO, "ADN:", "\n%s Properties\n", textureFileName);
    __android_log_print(ANDROID_LOG_INFO, "ADN:", "-------------------------------------------\n");
    __android_log_print(ANDROID_LOG_INFO, "ADN:", "Image Width = %d\n", imageWidth);
    __android_log_print(ANDROID_LOG_INFO, "ADN:", "Image Height = %d\n", imageHeight);
    __android_log_print(ANDROID_LOG_INFO, "ADN:", "Image Size = %lu\n", imageSize);
    __android_log_print(ANDROID_LOG_INFO, "ADN:", "-------------------------------------------\n\n");   
   ...
   //! Step - 2
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Staging Buffer : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (imageData)
        {
            ...
            imageData = NULL;
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => stbi_image_free() Called For Texture : %s\n", __func__, textureFileName);
        }
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded For Staging Buffer : %s\n", __func__, textureFileName);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Staging Buffer : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkBuffer_stagingBuffer)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vkBuffer_stagingBuffer\n", __func__);
        }
        if (imageData)
        {
            stbi_image_free(imageData);
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Staging Buffer : %s\n", __func__, textureFileName);

    vkResult = vkBindBufferMemory(vkDevice, vkBuffer_stagingBuffer, vkDeviceMemory_stagingBuffer, 0);
    if (vkResult != VK_SUCCESS)
    { 
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed For Staging Buffer : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkDeviceMemory_stagingBuffer)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vkDeviceMemory_stagingBuffer\n", __func__);
        }
        if (vkBuffer_stagingBuffer)
        {
            vkDestroyBuffer(vkDevice, vkBuffer_stagingBuffer, NULL);
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded For Staging Buffer : %s\n", __func__, textureFileName);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed For Staging Buffer : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Succeeded For Staging Buffer : %s\n", __func__, textureFileName);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImage() Failed For Texture : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImage() Succeeded For Texture : %s\n", __func__, textureFileName);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Texture : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Texture : %s\n", __func__, textureFileName);

    vkResult = vkBindImageMemory(vkDevice, vkImage_texture_fbo, vkDeviceMemory_texture_fbo, 0);
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindImageMemory() Failed For Texture : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindImageMemory() Succeeded For Texture : %s\n", __func__, textureFileName);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateCommandBuffers() Failed For vkCommandBuffer_transition_image_layout : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateCommandBuffers() Succeeded For vkCommandBuffer_transition_image_layout\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBeginCommandBuffer() Failed For vkCommandBuffer_transition_image_layout : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkCommandBuffer_transition_image_layout)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeCommandBuffers() Succeeded For vkCommandBuffer_transition_image_layout\n", __func__);
        }
        if (vkDeviceMemory_stagingBuffer)
        {
            vkFreeMemory(vkDevice, vkDeviceMemory_stagingBuffer, NULL);
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBeginCommandBuffer() Succeeded For vkCommandBuffer_transition_image_layout\n", __func__);
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "ERROR : %s() => Unsupported Texture Layout Transition !!!\n", __func__);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "ERROR : %s() => vkEndCommandBuffer() Failed For vkCommandBuffer_transition_image_layout : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkEndCommandBuffer() Succeeded For vkCommandBuffer_transition_image_layout\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "ERROR : %s() => vkQueueSubmit() Failed For vkSubmitInfo_transition_image_layout : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkQueueSubmit() Succeeded For vkSubmitInfo_transition_image_layout\n", __func__);

    //* Step - 4.6
    vkResult = vkQueueWaitIdle(vkQueue);
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "ERROR : %s() => vkQueueWaitIdle() Failed For vkSubmitInfo_transition_image_layout : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkQueueWaitIdle() Succeeded For vkCommandBuffer_transition_image_layout\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateCommandBuffers() Failed For vkCommandBuffer_buffer_to_image_copy : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateCommandBuffers() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "ERROR : %s() => vkBeginCommandBuffer() Failed For vkCommandBuffer_buffer_to_image_copy : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkCommandBuffer_buffer_to_image_copy)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "ERROR : %s() => vkFreeCommandBuffers() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
        }
        if (vkDeviceMemory_stagingBuffer)
        {
            vkFreeMemory(vkDevice, vkDeviceMemory_stagingBuffer, NULL);
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBeginCommandBuffer() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "ERROR : %s() => vkEndCommandBuffer() Failed For vkCommandBuffer_buffer_to_image_copy : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkCommandBuffer_buffer_to_image_copy)
        {
            vkFreeCommandBuffers(vkDevice, vkCommandPool, 1, &vkCommandBuffer_buffer_to_image_copy);
            vkCommandBuffer_buffer_to_image_copy = VK_NULL_HANDLE;
            __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeCommandBuffers() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
        }
        if (vkImage_texture_fbo)
        {
            vkDestroyImage(vkDevice, vkImage_texture_fbo, NULL);
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkEndCommandBuffer() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "ERROR : %s() => vkQueueSubmit() Failed For vkSubmitInfo_buffer_to_copy : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkQueueSubmit() Succeeded For vkSubmitInfo_buffer_to_copy\n", __func__);

    vkResult = vkQueueWaitIdle(vkQueue);
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "ERROR : %s() => vkQueueWaitIdle() Failed For vkCommandBuffer_buffer_to_image_copy : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkQueueWaitIdle() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImageView() Failed For Texture : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }   
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateImageView() Succeeded For Texture : %s\n", __func__, textureFileName);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateSampler() Failed For Texture : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }    
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateSampler() Succeeded For Texture : %s\n", __func__, textureFileName);
...
VkResult createUniformBuffer_fbo(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Uniform Data (FBO) : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded For Uniform Data (FBO)\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Uniform Data (FBO) : %d !!!\n", __func__, vkResult);
        return vkResult;
    }     
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Uniform Data (FBO)\n", __func__);

    vkResult = vkBindBufferMemory(vkDevice, uniformData_fbo.vkBuffer, uniformData_fbo.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed For Uniform Data (FBO) : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded For Uniform Data (FBO)\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => updateUniformBuffer_fbo() Succeeded\n", __func__);
...
VkResult updateUniformBuffer_fbo(void)
{
   // Variable Declarations
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed For Uniform Buffer (FBO) : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
...
VkResult createDescriptorSetLayout_fbo(void)
{
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateDescriptorSetLayout() Failed (FBO) : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateDescriptorSetLayout() Succeeded (FBO)\n", __func__);
...
VkResult createFramebuffer_fbo(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateFramebuffer() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
...
VkResult createSemaphore_fbo(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateSemaphore() Failed For vkSemaphore_fbo : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
...
VkResult buildCommandBuffer_fbo(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkResetCommandBuffer() Failed Reason : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkResetCommandBuffer() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBeginCommandBuffer() Failed : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBeginCommandBuffer() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkEndCommandBuffer() Failed : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkEndCommandBuffer() Succeeded\n", __func__);
