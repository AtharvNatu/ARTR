...
const float fAnimationSpeed = 0.06f;
float fAngle = 0.0f;
...
VkResult uninitialize(void)
{
   ...
   //* Step - 5 of PipelineLayout
    ...
    if (vertexData_pcnt.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkFreeMemory() Succeeded For vertexData_pcnt.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_pcnt.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyBuffer() Succeeded For vertexData_pcnt.vkBuffer\n", __func__);
    }
...
VkResult createVertexBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Failed For Interleaved Buffer  : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateBuffer() Succeeded For Interleaved Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Failed For Interleaved Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkAllocateMemory() Succeeded For Interleaved Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Failed For Interleaved Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkBindBufferMemory() Succeeded For Interleaved Buffer\n", __func__);

    //* Step - 11
    void* data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_pcnt.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Failed For Interleaved Buffer : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkMapMemory() Succeeded For Interleaved Buffer\n", __func__);
...
VkResult createPipeline(void)
{
    ...
    vkVertexInputAttributeDescription_array[1].offset = sizeof(float) * 3;
    ...
    vkVertexInputAttributeDescription_array[2].offset = sizeof(float) * 6;
    ...
    vkVertexInputAttributeDescription_array[3].offset = sizeof(float) * 9;
