...
VkResult uninitialize(void)
{
   ...
   //* Step - 5 of PipelineLayout
    ...
    if (vkShaderModule_geometry_shader)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkDestroyShaderModule() Succeeded For Geometry Shader\n", __func__);
    }
...
VkResult createVulkanDevice(void)
{
    ...
    else
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "ERROR : Selected Device Does Not Support Geometry Shader : %d !!!\n", vkResult);
        return VK_ERROR_INITIALIZATION_FAILED;
    }
...
VkResult createShaders(void)
{
    ...
    if (vkResult != VK_SUCCESS)
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateShaderModule() Failed For Geometry Shader : %d !!!\n", __func__, vkResult);
    else
        __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => vkCreateShaderModule() Succeeded For Geometry Shader\n", __func__);
    ...
    __android_log_print(ANDROID_LOG_INFO, "ADN:", "%s() => Geometry Shader Module Successfully Created\n", __func__);
    //! ---------------------------------------------------------------------------------------------------------------------------
