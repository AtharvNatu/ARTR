...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(
        WS_EX_APPWINDOW,
        szAppName,
        TEXT("Atharv Natu : Vulkan Normal Per-Vertex | Per-Fragment Light Toggle On Sphere"),
...
VkResult updateUniformBuffer(void)
{
    ...
    if (chosenShader == 'v')
    {
        ...
        host_uniformData_pv.lightAmbient[0] = 0.0f;
        host_uniformData_pv.lightAmbient[1] = 0.0f;
        host_uniformData_pv.lightAmbient[2] = 0.0f;
    ...
    else if (chosenShader == 'f')
    {
        ...
        //! Update Light Related Uniforms
        host_uniformData_pf.lightAmbient[0] = 0.0f;
        host_uniformData_pf.lightAmbient[1] = 0.0f;
        host_uniformData_pf.lightAmbient[2] = 0.0f;
