...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(
        WS_EX_APPWINDOW,
        szAppName,
        TEXT("Atharv Natu : Vulkan Albedo Per-Vertex | Per-Fragment Light Toggle On Sphere"),
...
VkResult updateUniformBuffer(void)
{
    ...
    if (chosenShader == 'v')
    {
        ...
        host_uniformData_pv.lightAmbient[0] = 0.1f;
        host_uniformData_pv.lightAmbient[1] = 0.1f;
        host_uniformData_pv.lightAmbient[2] = 0.1f;
        host_uniformData_pv.lightAmbient[3] = 1.0f;

        host_uniformData_pv.lightDiffuse[0] = 1.0f;
        host_uniformData_pv.lightDiffuse[1] = 1.0f;
        host_uniformData_pv.lightDiffuse[2] = 1.0f;
        host_uniformData_pv.lightDiffuse[3] = 1.0f;

        host_uniformData_pv.lightSpecular[0] = 1.0f;
        host_uniformData_pv.lightSpecular[1] = 1.0f;
        host_uniformData_pv.lightSpecular[2] = 1.0f;
        host_uniformData_pv.lightSpecular[3] = 1.0f;

        host_uniformData_pv.lightPosition[0] = 100.0f;
        host_uniformData_pv.lightPosition[1] = 100.0f;
        host_uniformData_pv.lightPosition[2] = 100.0f;
        host_uniformData_pv.lightPosition[3] = 1.0f;
        ...
        host_uniformData_pv.materialDiffuse[0] = 0.5f;
        host_uniformData_pv.materialDiffuse[1] = 0.2f;
        host_uniformData_pv.materialDiffuse[2] = 0.7f;
        host_uniformData_pv.materialDiffuse[3] = 1.0f;

        host_uniformData_pv.materialSpecular[0] = 0.7f;
        host_uniformData_pv.materialSpecular[1] = 0.7f;
        host_uniformData_pv.materialSpecular[2] = 0.7f;
        host_uniformData_pv.materialSpecular[3] = 1.0f;

        host_uniformData_pv.materialShininess = 128.0f;
    ...
    else if (chosenShader == 'f')
    {
        ...
        //! Update Light Related Uniforms
        host_uniformData_pf.lightAmbient[0] = 0.1f;
        host_uniformData_pf.lightAmbient[1] = 0.1f;
        host_uniformData_pf.lightAmbient[2] = 0.1f;
        host_uniformData_pf.lightAmbient[3] = 1.0f;

        host_uniformData_pf.lightDiffuse[0] = 1.0f;
        host_uniformData_pf.lightDiffuse[1] = 1.0f;
        host_uniformData_pf.lightDiffuse[2] = 1.0f;
        host_uniformData_pf.lightDiffuse[3] = 1.0f;

        host_uniformData_pf.lightSpecular[0] = 1.0f;
        host_uniformData_pf.lightSpecular[1] = 1.0f;
        host_uniformData_pf.lightSpecular[2] = 1.0f;
        host_uniformData_pf.lightSpecular[3] = 1.0f;

        host_uniformData_pf.lightPosition[0] = 100.0f;
        host_uniformData_pf.lightPosition[1] = 100.0f;
        host_uniformData_pf.lightPosition[2] = 100.0f;
        host_uniformData_pf.lightPosition[3] = 1.0f;
        ...
        host_uniformData_pf.materialDiffuse[0] = 0.5f;
        host_uniformData_pf.materialDiffuse[1] = 0.2f;
        host_uniformData_pf.materialDiffuse[2] = 0.7f;
        host_uniformData_pf.materialDiffuse[3] = 1.0f;

        host_uniformData_pf.materialSpecular[0] = 0.7f;
        host_uniformData_pf.materialSpecular[1] = 0.7f;
        host_uniformData_pf.materialSpecular[2] = 0.7f;
        host_uniformData_pf.materialSpecular[3] = 1.0f;

        host_uniformData_pf.materialShininess = 128.0f;
