...
if %SPV%==1 (
    ...
    %VULKAN_BIN_PATH%\glslangValidator.exe -V -H -o Shader.tesc.spv Shader.tesc
    %VULKAN_BIN_PATH%\glslangValidator.exe -V -H -o Shader.tese.spv Shader.tese
    %VULKAN_BIN_PATH%\glslangValidator.exe -V -H -o Shader.frag.spv Shader.frag
    move Shader.vert.spv ../%BIN_DIR%
    move Shader.tesc.spv ../%BIN_DIR%
    move Shader.tese.spv ../%BIN_DIR%
