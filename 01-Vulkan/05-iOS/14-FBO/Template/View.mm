...
-(void) onSingleTap:(UITapGestureRecognizer*)gestureRecognizer
{
    // Code
    singleTapCount++;
    switch(singleTapCount)
    {
        case 1: bAnimate = YES;    break;
        case 2: bLight = YES;      break;
        case 3: bTexture = YES;    break;
        case 4: bTexture = NO;     break;
        case 5: bLight = NO;       break;
        case 6: bAnimate = NO;     break;

        default: singleTapCount = 0;
    }
}
...
-(VkResult) initialize
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createImagesAndImageViews_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createImagesAndImageViews_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createCommandBuffer_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createCommandBuffer_fbo() Succeeded\n", __func__);
    ...
    if (pPositions == NULL)
    {
        printf("%s() => malloc() Failed For pPositions : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (pNormals == NULL)
    {
        printf("%s() => malloc() Failed For pNormals : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (pTexCoords == NULL)
    {
        printf("%s() => malloc() Failed For pTexCoords : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (pElements == NULL)
    {
        printf("%s() => malloc() Failed For pElements : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createVertexBuffer_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createVertexBuffer_fbo() Succeeded\n", __func__);

    //! Create Index Buffer
    vkResult = [self createIndexBuffer_fbo];
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createIndexBuffer_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createIndexBuffer_fbo() Succeeded\n", __func__);

    //! Create Texture
    NSString *iconFilePath = [[NSBundle mainBundle] pathForResource:@"Marble" ofType:@"png"];
    const char* textureFileName = [iconFilePath UTF8String];
    vkResult = [self createTexture_fbo:textureFileName];
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createTexture_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createTexture_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createUniformBuffer_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createUniformBuffer_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createShaders_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createShaders_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
       printf("%s() => createDescriptorSetLayout_fbo() Failed : %d !!!\n", __func__, vkResult);
       vkResult = VK_ERROR_INITIALIZATION_FAILED;
       return vkResult;
    }
    else
       printf("%s() => createDescriptorSetLayout_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createPipelineLayout_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createPipelineLayout_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createDescriptorPool_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createDescriptorPool_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createDescriptorSet_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createDescriptorSet_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createRenderPass_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createRenderPass_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createPipeline_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createPipeline_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createFramebuffer_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createFramebuffer_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createSemaphore_fbo() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createSemaphore_fbo() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => buildCommandBuffer_fbo() Failed\n", __func__);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => buildCommandBuffer_fbo() Succeeded\n", __func__);
...
-(VkResult) resize:(int)width :(int)height
{
    ...
    bInitialized = NO;
    {
        ...
        if (vkResult != VK_SUCCESS)
        {
            printf("%s() => vkResetDescriptorPool() Failed\n", __func__);
            return vkResult;
        }
...
-(VkResult) render
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkQueueSubmit() Failed For FBO : %d\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => updateUniformBuffer_fbo() Failed : %d\n", __func__, vkResult);
...
-(void) uninitialize
{
    ...
    if (vkSampler_texture)
    {
        ...
        printf("%s() => vkDestroySampler() Succeeded For vkSampler_texture\n", __func__);
    }
    ...
    if (vkImageView_texture)
    {
        ...
        printf("%s() => vkDestroyImageView() Succeeded For vkImage_texture\n", __func__);
    }
    ...
    if (vkDeviceMemory_texture)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vkDeviceMemory_texture\n", __func__);
    }
    ...
    if (vkImage_texture)
    {
        ...
        printf("%s() => vkDestroyImage() Succeeded For vkImage_texture\n", __func__);
    }
    ...
    if (vertexData_texcoord.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_texcoord.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_texcoord.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_texcoord.vkBuffer\n", __func__);
    }
    ...
    if (vkImageView_depth)
    {
        vkDestroyImageView(vkDevice, vkImageView_depth, NULL);
        vkImageView_depth = VK_NULL_HANDLE;
        printf("%s() => vkDestroyImageView() Succeeded For vkImageView_depth\n", __func__);
    }
    ...
    if (vkImage_depth)
    {
        vkDestroyImage(vkDevice, vkImage_depth, NULL);
        vkImage_depth = VK_NULL_HANDLE;
        printf("%s() => vkDestroyImage() Succeeded For vkImage_depth\n", __func__);
    }
    ...
    if (vkDeviceMemory_depth)
    {
        vkFreeMemory(vkDevice, vkDeviceMemory_depth, NULL);
        vkDeviceMemory_depth = VK_NULL_HANDLE;
        printf("%s() => vkFreeMemory() Succeeded For vkDeviceMemory_depth\n", __func__);
    }
...
-(VkResult) createImagesAndImageViews
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => getSupportedDepthFormat() Failed : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => getSupportedDepthFormat() Succeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateImage() Failed : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateImage() Succeeded\n", __func__);
    ...
    if (foundMatchingMemoryType_depth == VK_FALSE)
    {
        ...
        printf("%s() => Device Local Memory Not Found : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindImageMemory() Failed For Depth : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkBindImageMemory() Succeeded For Depth\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateImageView() Failed For Depth : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateImageView() Succeeded For Depth\n", __func__);
...
-(VkResult) createVertexBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Position Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Position Buffer\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_vertex_position = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        //* Step - 8.2
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
            {
                //* Step - 8.4
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_position = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_position == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Position Buffer : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Position Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Position Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Position Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Position Buffer\n", __func__);

    //* Step - 11
    void* data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Position Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Position Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Texcoord Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Texcoord Buffer\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_vertex_texcoord = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        //* Step - 8.2
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
            {
                //* Step - 8.4
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_texcoord = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_texcoord == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Texcoord Buffer : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Texcoord Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Texcoord Buffer\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoord.vkBuffer, vertexData_texcoord.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Texcoord Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Texcoord Buffer\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_texcoord.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Texcoord Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Texcoord Buffer\n", __func__);
...
-(VkResult) createTexture:(const char*) textureFileName
{
    ...
    {
        printf("%s() => stbi_load() Failed For %s !!!\n", __func__, textureFileName);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateBuffer() Failed For Staging Buffer : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (imageData)
        {
            ...
            imageData = NULL;
            printf("%s() => stbi_image_free() Called For Texture : %s\n", __func__, textureFileName);
        }
        ...
        printf("%s() => vkCreateBuffer() Succeeded For Staging Buffer : %s\n", __func__, textureFileName);
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible | Host Coherent Memory Not Found For Staging Buffer : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For Staging Buffer : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkBuffer_stagingBuffer)
        {
            ...
            printf("%s() => vkDestroyBuffer() Succeeded For vkBuffer_stagingBuffer\n", __func__);
        }
        if (imageData)
        {
            stbi_image_free(imageData);
        ...
        printf("%s() => vkAllocateMemory() Succeeded For Staging Buffer : %s\n", __func__, textureFileName);

    vkResult = vkBindBufferMemory(vkDevice, vkBuffer_stagingBuffer, vkDeviceMemory_stagingBuffer, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindBufferMemory() Failed For Staging Buffer : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkDeviceMemory_stagingBuffer)
        {
            ...
            printf("%s() => vkFreeMemory() Succeeded For vkDeviceMemory_stagingBuffer\n", __func__);
        }
        if (vkBuffer_stagingBuffer)
        {
            vkDestroyBuffer(vkDevice, vkBuffer_stagingBuffer, NULL);
        ...
        printf("%s() => vkBindBufferMemory() Succeeded For Staging Buffer : %s\n", __func__, textureFileName);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkMapMemory() Failed For Staging Buffer : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkMapMemory() Succeeded For Staging Buffer : %s\n", __func__, textureFileName);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateImage() Failed For Texture : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkCreateImage() Succeeded For Texture : %s\n", __func__, textureFileName);
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Device Local Memory Not Found For Texture : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For Texture : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkAllocateMemory() Succeeded For Texture : %s\n", __func__, textureFileName);

    vkResult = vkBindImageMemory(vkDevice, vkImage_texture, vkDeviceMemory_texture, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindImageMemory() Failed For Texture : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkBindImageMemory() Succeeded For Texture : %s\n", __func__, textureFileName);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateCommandBuffers() Failed For vkCommandBuffer_transition_image_layout : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkAllocateCommandBuffers() Succeeded For vkCommandBuffer_transition_image_layout\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBeginCommandBuffer() Failed For vkCommandBuffer_transition_image_layout : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkCommandBuffer_transition_image_layout)
        {
            ...
            printf("%s() => vkFreeCommandBuffers() Succeeded For vkCommandBuffer_transition_image_layout\n", __func__);
        }
        if (vkDeviceMemory_stagingBuffer)
        {
            vkFreeMemory(vkDevice, vkDeviceMemory_stagingBuffer, NULL);
        ...
        printf("%s() => vkBeginCommandBuffer() Succeeded For vkCommandBuffer_transition_image_layout\n", __func__);
    ...
    {
        printf("ERROR : %s() => Unsupported Texture Layout Transition !!!\n", __func__);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("ERROR : %s() => vkEndCommandBuffer() Failed For vkCommandBuffer_transition_image_layout : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkEndCommandBuffer() Succeeded For vkCommandBuffer_transition_image_layout\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("ERROR : %s() => vkQueueSubmit() Failed For vkSubmitInfo_transition_image_layout : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkQueueSubmit() Succeeded For vkSubmitInfo_transition_image_layout\n", __func__);

    //* Step - 4.6
    vkResult = vkQueueWaitIdle(vkQueue);
    if (vkResult != VK_SUCCESS)
    {
        printf("ERROR : %s() => vkQueueWaitIdle() Failed For vkSubmitInfo_transition_image_layout : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkQueueWaitIdle() Succeeded For vkCommandBuffer_transition_image_layout\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateCommandBuffers() Failed For vkCommandBuffer_buffer_to_image_copy : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkAllocateCommandBuffers() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("ERROR : %s() => vkBeginCommandBuffer() Failed For vkCommandBuffer_buffer_to_image_copy : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkCommandBuffer_buffer_to_image_copy)
        {
            ...
            printf("ERROR : %s() => vkFreeCommandBuffers() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
        }
        if (vkDeviceMemory_stagingBuffer)
        {
            vkFreeMemory(vkDevice, vkDeviceMemory_stagingBuffer, NULL);
        ...
        printf("%s() => vkBeginCommandBuffer() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("ERROR : %s() => vkEndCommandBuffer() Failed For vkCommandBuffer_buffer_to_image_copy : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkCommandBuffer_buffer_to_image_copy)
        {
            vkFreeCommandBuffers(vkDevice, vkCommandPool, 1, &vkCommandBuffer_buffer_to_image_copy);
            vkCommandBuffer_buffer_to_image_copy = VK_NULL_HANDLE;
            printf("%s() => vkFreeCommandBuffers() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
        }
        if (vkImage_texture)
        {
            vkDestroyImage(vkDevice, vkImage_texture, NULL);
        ...
        printf("%s() => vkEndCommandBuffer() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("ERROR : %s() => vkQueueSubmit() Failed For vkSubmitInfo_buffer_to_copy : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkQueueSubmit() Succeeded For vkSubmitInfo_buffer_to_copy\n", __func__);

    vkResult = vkQueueWaitIdle(vkQueue);
    if (vkResult != VK_SUCCESS)
    {
        printf("ERROR : %s() => vkQueueWaitIdle() Failed For vkCommandBuffer_buffer_to_image_copy : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkQueueWaitIdle() Succeeded For vkCommandBuffer_buffer_to_image_copy\n", __func__);
    ...
    //! Changed RGBA to BGRA for iOS
    vkImageViewCreateInfo.format = VK_FORMAT_B8G8R8A8_UNORM;
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateImageView() Failed For Texture : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkCreateImageView() Succeeded For Texture : %s\n", __func__, textureFileName);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateSampler() Failed For Texture : %s, Error Code : %d !!!\n", __func__, textureFileName, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkCreateSampler() Succeeded For Texture : %s\n", __func__, textureFileName);
...
-(void) uninitialize_fbo
{
    ...
    if (vkSemaphore_fbo)
    {
        ...
        printf("%s() => vkDestroySemaphore() Succeeded For vkSemaphore_fbo\n", __func__);
    ...
    if (vkPipeline_fbo)
    {
        vkDestroyPipeline(vkDevice, vkPipeline_fbo, NULL);
        vkPipeline_fbo = VK_NULL_HANDLE;
        printf("%s() => vkDestroyPipeline() Succeeded For vkPipeline_fbo\n", __func__);
    }
    ...
    if (vkRenderPass_fbo)
    {
        vkDestroyRenderPass(vkDevice, vkRenderPass_fbo, NULL);
        vkRenderPass_fbo = VK_NULL_HANDLE;
        printf("%s() => vkDestroyRenderPass() Succeeded For vkRenderPass_fbo\n", __func__);
    }
    ...
    if (vkDescriptorPool_fbo)
    {
        ...
        printf("%s() => vkDestroyDescriptorPool() => Destroyed vkDescriptorPool_fbo and vkDescriptorSet_fbo Successfully\n", __func__);
    }
    ...
    if (vkPipelineLayout_fbo)
    {
        vkDestroyPipelineLayout(vkDevice, vkPipelineLayout_fbo, NULL);
        vkPipelineLayout_fbo = VK_NULL_HANDLE;
        printf("%s() => vkDestroyPipelineLayout() Succeeded For vkPipelineLayout_fbo\n", __func__);
    }
    ...
    if (vkDescriptorSetLayout_fbo)
    {
        ...
        printf("%s() => vkDestroyDescriptorSetLayout() Succeeded For vkDescriptorSetLayout_fbo\n", __func__);
    }
    ...
    if (vkShaderModule_fragment_shader_fbo)
    {
        ...
        printf("%s() => vkDestroyShaderModule() Succeeded For FBO Fragment Shader\n", __func__);
    }
    ...
    if (vkShaderModule_vertex_shader_fbo)
    {
        ...
        printf("%s() => vkDestroyShaderModule() Succeeded For FBO Vertex Shader\n", __func__);
    }
    ...
    if (uniformData_fbo.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For uniformData_fbo.vkDeviceMemory\n", __func__);
    }
    ...
    if (uniformData_fbo.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For uniformData_fbo.vkBuffer\n", __func__);
    }
    ...
    if (vkSampler_texture_fbo)
    {
        ...
        printf("%s() => vkDestroySampler() Succeeded For vkSampler_texture_fbo\n", __func__);
    }
    ...
    if (vkImageView_texture_fbo)
    {
        ...
        printf("%s() => vkDestroyImageView() Succeeded For vkImage_texture_fbo\n", __func__);
    }
    ...
    if (vkDeviceMemory_texture_fbo)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vkDeviceMemory_texture_fbo\n", __func__);
    }
    ...
    if (vkImage_texture_fbo)
    {
        ...
        printf("%s() => vkDestroyImage() Succeeded For vkImage_texture_fbo\n", __func__);
    }
    ...
    if (vertexData_index_fbo.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_index_fbo.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_index_fbo.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_index_fbo.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_texcoords_fbo.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_texcoords_fbo.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_texcoords_fbo.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_texcoords_fbo.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_normals_fbo.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_normals_fbo.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_normals_fbo.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_normals_fbo.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_position_fbo.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_position_fbo.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_position_fbo.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_position_fbo.vkBuffer\n", __func__);
    }
    ...
    if (vkCommandBuffer_fbo)
    {
        ...
        printf("%s() => free() Succeeded For vkCommandBuffer_fbo\n", __func__);
    }
    ...
    if (vkImageView_depth_fbo)
    {
        vkDestroyImageView(vkDevice, vkImageView_depth_fbo, NULL);
        vkImageView_depth_fbo = VK_NULL_HANDLE;
        printf("%s() => vkDestroyImageView() Succeeded For vkImageView_depth_fbo\n", __func__);
    }
    ...
    if (vkImage_depth_fbo)
    {
        vkDestroyImage(vkDevice, vkImage_depth_fbo, NULL);
        vkImage_depth_fbo = VK_NULL_HANDLE;
        printf("%s() => vkDestroyImage() Succeeded For vkImage_depth_fbo\n", __func__);
    }
    ...
    if (vkDeviceMemory_depth_fbo)
    {
        vkFreeMemory(vkDevice, vkDeviceMemory_depth_fbo, NULL);
        vkDeviceMemory_depth_fbo = VK_NULL_HANDLE;
        printf("%s() => vkFreeMemory() Succeeded For vkDeviceMemory_depth_fbo\n", __func__);
    }
    ...
    if (vkSampler_fbo)
    {
        vkDestroySampler(vkDevice, vkSampler_fbo, NULL);
        vkSampler_fbo = VK_NULL_HANDLE;
        printf("%s() => vkDestroySampler() Succeeded For vkSampler_fbo\n", __func__);
    }
    ...
    if (vkImageView_fbo)
    {
        ...
        printf("%s() => vkDestroyImageView() Succeeded For vkImageView_fbo\n", __func__);
    }
    ...
    if (vkDeviceMemory_fbo)
    {
        vkFreeMemory(vkDevice, vkDeviceMemory_fbo, NULL);
        vkDeviceMemory_fbo = VK_NULL_HANDLE;
        printf("%s() => vkFreeMemory() Succeeded For vkDeviceMemory_fbo\n", __func__);
    }
    ...
    if (vkImage_fbo)
    {
        vkDestroyImage(vkDevice, vkImage_fbo, NULL);
        vkImage_fbo = NULL;
        printf("%s() => vkDestroyImage() Succeeded For vkImage_fbo\n", __func__);
    }
...
-(VkResult) createImagesAndImageViews_fbo
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateImage() Failed For FBO Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkCreateImage() Succeeded For FBO Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For FBO Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkAllocateMemory() Succeeded For FBO Texture\n", __func__);

    vkResult = vkBindImageMemory(vkDevice, vkImage_fbo, vkDeviceMemory_fbo, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindImageMemory() Failed For FBO Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkBindImageMemory() Succeeded For FBO Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateImageView() Failed For FBO Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkCreateImageView() Succeeded FBO Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateSampler() Failed For FBO Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkCreateSampler() Succeeded For FBO Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateImage() Failed For FBO Depth Image : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateImage() Succeeded For FBO Depth Image\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For FBO Depth : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateMemory() Succeeded For FBO Depth\n", __func__);

    vkResult = vkBindImageMemory(vkDevice, vkImage_depth_fbo, vkDeviceMemory_depth_fbo, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindImageMemory() Failed For FBO Depth : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkBindImageMemory() Succeeded For FBO Depth\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateImageView() Failed For FBO Depth : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateImageView() Succeeded For FBO Depth\n", __func__);
...
-(VkResult) createCommandBuffer_fbo
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateCommandBuffers() Failed For vkCommandBuffer_fbo: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateCommandBuffers() Succeeded For vkCommandBuffer_fbo\n", __func__);
...
-(VkResult) createVertexBuffer_fbo
{
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Position : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Normals Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Normals Buffer\n", __func__);
    ...
    VkBool32 foundMatchingMemoryType_vertex_normals = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            {
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_normals = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_normals == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Normals : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Normals Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Normals Buffer\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_normals_fbo.vkBuffer, vertexData_normals_fbo.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Normals Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Normals Buffer\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_normals_fbo.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Normals Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Normals Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Texcoords Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Texcoords Buffer\n", __func__);
    ...
    VkBool32 foundMatchingMemoryType_vertex_texcoords = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            {
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_texcoords = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_texcoords == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Texcoords : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Texcoords Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Texcoords Buffer\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoords_fbo.vkBuffer, vertexData_texcoords_fbo.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Texcoords Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Texcoords Buffer\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_texcoords_fbo.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Texcoords Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Texcoords Buffer\n", __func__);
...
-(VkResult) createIndexBuffer_fbo
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Index Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Index Buffer\n", __func__);
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Index Buffer : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Index Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Index Buffer\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_index_fbo.vkBuffer, vertexData_index_fbo.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Index Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Index Buffer\n", __func__);

    //* Step - 11
    void* data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_index_fbo.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Index Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Index Buffer\n", __func__);
...
-(VkResult) createUniformBuffer_fbo
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateBuffer() Failed For Uniform Data (FBO) : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkCreateBuffer() Succeeded For Uniform Data (FBO)\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For Uniform Data (FBO) : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateMemory() Succeeded For Uniform Data (FBO)\n", __func__);

    vkResult = vkBindBufferMemory(vkDevice, uniformData_fbo.vkBuffer, uniformData_fbo.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindBufferMemory() Failed For Uniform Data (FBO) : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Uniform Data (FBO)\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        ...
        printf("%s() => updateUniformBuffer_fbo() Succeeded\n", __func__);
...
-(VkResult) updateUniformBuffer_fbo
{
   // Variable Declarations
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkMapMemory() Failed For Uniform Buffer (FBO) : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
...
-(VkResult) createDescriptorSetLayout_fbo
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateDescriptorSetLayout() Failed (FBO) : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateDescriptorSetLayout() Succeeded (FBO)\n", __func__);
...
-(VkResult) createFramebuffer_fbo
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateFramebuffer() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
...
-(VkResult) createSemaphore_fbo
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateSemaphore() Failed For vkSemaphore_fbo : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
...
-(VkResult) buildCommandBuffer_fbo
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkResetCommandBuffer() Failed Reason : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkResetCommandBuffer() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBeginCommandBuffer() Failed : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkBeginCommandBuffer() Succeeded\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkEndCommandBuffer() Failed : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkEndCommandBuffer() Succeeded\n", __func__);
