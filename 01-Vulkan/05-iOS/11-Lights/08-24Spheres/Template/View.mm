...
-(VkResult) initialize
{
    ...
    numVertices = (unsigned int)sphere->get_number_of_vertices();
    numIndices = (unsigned int)sphere->get_number_of_indices();
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createIndexBuffer() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createIndexBuffer() Succeeded\n", __func__);
...
-(void) uninitialize
{
    ...
    if (vertexData_index.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_index.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_index.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_index.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_normals.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_normals.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_normals.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_normals.vkBuffer\n", __func__);
    }
    ...
    if (vkImageView_colorMSAA)
    {
       vkDestroyImageView(vkDevice, vkImageView_colorMSAA, NULL);
       vkImageView_colorMSAA = VK_NULL_HANDLE;
       printf("%s() => vkDestroyImageView() Succeeded For vkImageView_colorMSAA\n", __func__);
    }
    ...
    if (vkImage_colorMSAA)
    {
       vkDestroyImage(vkDevice, vkImage_colorMSAA, NULL);
       vkImage_colorMSAA = VK_NULL_HANDLE;
       printf("%s() => vkDestroyImage() Succeeded For vkImage_colorMSAA\n", __func__);
    }
    ...
    if (vkDeviceMemory_colorMSAA)
    {
       vkFreeMemory(vkDevice, vkDeviceMemory_colorMSAA, NULL);
       vkDeviceMemory_colorMSAA = VK_NULL_HANDLE;
       printf("%s() => vkFreeMemory() Succeeded For vkDeviceMemory_colorMSAA\n", __func__);
    }
...
-(VkResult) createImagesAndImageViews
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateImage() Failed For MSAA Color Image : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateImage() Succeeded For MSAA Color Image\n", __func__);
    ...
    if (foundMatchingMemoryType_colorMSAA == VK_FALSE)
    {
        ...
        printf("%s() => Device Local Memory Not Found For MSAA Color Image : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For MSAA Color Image : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateMemory() Succeeded For MSAA Color Image\n", __func__);

    vkResult = vkBindImageMemory(vkDevice, vkImage_colorMSAA, vkDeviceMemory_colorMSAA, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindImageMemory() Failed For MSAA Color Image : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkBindImageMemory() Succeeded For MSAA Color Image\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateImageView() Failed For MSAA Color Image : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateImageView() Succeeded For MSAA Color Image\n", __func__);
    //! ----------------------------------------------------------------------------------------------------------------
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateImage() Failed For Depth Image : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateImage() Succeeded For Depth Image\n", __func__);
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Device Local Memory Not Found For Depth Image : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
...
-(VkResult) createVertexBuffer
{
    ...
    vkBufferCreateInfo.size = sphere->get_number_of_vertices() * sizeof(float);
    ...
    //* Step - 12
    memcpy(data, sphere->get_vertices().data(), sphere->get_number_of_vertices() * sizeof(float));
    ...
    vkBufferCreateInfo.flags = 0;   //! Valid Flags are used in sparse(scattered) buffers
    vkBufferCreateInfo.pNext = NULL;
    vkBufferCreateInfo.size = sphere->get_number_of_normals() * sizeof(float);
    vkBufferCreateInfo.usage = VK_BUFFER_USAGE_VERTEX_BUFFER_BIT;
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Normals Buffer : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    //* Step - 12
    memcpy(data, sphere->get_normals().data(), sphere->get_number_of_normals() * sizeof(float));
...
-(VkResult) createIndexBuffer
{
    ...
    vkBufferCreateInfo.flags = 0;   //! Valid Flags are used in sparse(scattered) buffers
    vkBufferCreateInfo.pNext = NULL;
    vkBufferCreateInfo.size = sphere->get_number_of_indices() * sizeof(uint32_t);
    ...
    //* Step - 12
    memcpy(data, sphere->get_indices().data(), sphere->get_number_of_indices() * sizeof(uint32_t));
...
-(VkResult) buildCommandBuffers
{
    ...
    for (uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        vkCmdBeginRenderPass(vkCommandBuffer_array[i], &vkRenderPassBeginInfo, VK_SUBPASS_CONTENTS_INLINE);
        {
            ...
            vkViewport.x = 50.0f * (float)vkExtent2D_swapchain.width / 800.0f;
            vkViewport.y = 30.0f * (float)vkExtent2D_swapchain.height / 600.0f;
            vkViewport.width = (float)vkExtent2D_swapchain.width / 8.0f;
            vkViewport.height = (float)vkExtent2D_swapchain.height / 8.0f;
            ...
            memset((void*)&vkViewport, 0, sizeof(VkViewport));
            vkViewport.x = 50.0f * (float)vkExtent2D_swapchain.width / 800.0f;
            vkViewport.y = 120.0f * (float)vkExtent2D_swapchain.height / 600.0f;
            vkViewport.width = (float)vkExtent2D_swapchain.width / 8.0f;
            vkViewport.height = (float)vkExtent2D_swapchain.height / 8.0f;
            vkViewport.minDepth = 0.0f;
            vkViewport.maxDepth = 1.0f;
            ...
            memset((void*)&vkViewport, 0, sizeof(VkViewport));
            vkViewport.x = 50.0f * (float)vkExtent2D_swapchain.width / 800.0f;
            vkViewport.y = 210.0f * (float)vkExtent2D_swapchain.height / 600.0f;
            vkViewport.width = (float)vkExtent2D_swapchain.width / 8.0f;
            vkViewport.height = (float)vkExtent2D_swapchain.height / 8.0f;
            vkViewport.minDepth = 0.0f;
            vkViewport.maxDepth = 1.0f;
            ...
            memset((void*)&vkViewport, 0, sizeof(VkViewport));
            vkViewport.x = 50.0f * (float)vkExtent2D_swapchain.width / 800.0f;
            vkViewport.y = 300.0f * (float)vkExtent2D_swapchain.height / 600.0f;
            vkViewport.width = (float)vkExtent2D_swapchain.width / 8.0f;
            vkViewport.height = (float)vkExtent2D_swapchain.height / 8.0f;
            vkViewport.minDepth = 0.0f;
            vkViewport.maxDepth = 1.0f;
            ...
            memset((void*)&vkViewport, 0, sizeof(VkViewport));
            vkViewport.x = 50.0f * (float)vkExtent2D_swapchain.width / 800.0f;
            vkViewport.y = 390.0f * (float)vkExtent2D_swapchain.height / 600.0f;
            vkViewport.width = (float)vkExtent2D_swapchain.width / 8.0f;
            vkViewport.height = (float)vkExtent2D_swapchain.height / 8.0f;
            vkViewport.minDepth = 0.0f;
            vkViewport.maxDepth = 1.0f;
            ...
            memset((void*)&vkViewport, 0, sizeof(VkViewport));
            vkViewport.x = 50.0f * (float)vkExtent2D_swapchain.width / 800.0f;
            vkViewport.y = 480.0f * (float)vkExtent2D_swapchain.height / 600.0f;
            vkViewport.width = (float)vkExtent2D_swapchain.width / 8.0f;
            vkViewport.height = (float)vkExtent2D_swapchain.height / 8.0f;
            vkViewport.minDepth = 0.0f;
            vkViewport.maxDepth = 1.0f;
            ...
            //! First Sphere -> Brass
            memset((void*)&vkViewport, 0, sizeof(VkViewport));
            vkViewport.x = 250.0f * (float)vkExtent2D_swapchain.width / 800.0f;
            vkViewport.y = 30.0f * (float)vkExtent2D_swapchain.height / 600.0f;
            vkViewport.width = (float)vkExtent2D_swapchain.width / 8.0f;
            vkViewport.height = (float)vkExtent2D_swapchain.height / 8.0f;
            vkViewport.minDepth = 0.0f;
            ...
            //! First Sphere -> Black
            memset((void*)&vkViewport, 0, sizeof(VkViewport));
            vkViewport.x = 450.0f * (float)vkExtent2D_swapchain.width / 800.0f;
            vkViewport.y = 30.0f * (float)vkExtent2D_swapchain.height / 600.0f;
            vkViewport.width = (float)vkExtent2D_swapchain.width / 8.0f;
            vkViewport.height = (float)vkExtent2D_swapchain.height / 8.0f;
            vkViewport.minDepth = 0.0f;
            ...
            //! First Sphere -> Black
            memset((void*)&vkViewport, 0, sizeof(VkViewport));
            vkViewport.x = 650.0f * (float)vkExtent2D_swapchain.width / 800.0f;
            vkViewport.y = 30.0f * (float)vkExtent2D_swapchain.height / 600.0f;
            vkViewport.width = (float)vkExtent2D_swapchain.width / 8.0f;
            vkViewport.height = (float)vkExtent2D_swapchain.height / 8.0f;
            vkViewport.minDepth = 0.0f;
