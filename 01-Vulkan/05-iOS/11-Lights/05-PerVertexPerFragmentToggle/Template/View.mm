...
typedef struct
{
    ...
    unsigned int useFragmentLighting;
...
{
    // Code
    bUseVertexShader = !bUseVertexShader;
}
...
-(VkResult) updateUniformBuffer
{
    ...
    if (bUseVertexShader)
        host_uniformData.useFragmentLighting = 0;
    else
        host_uniformData.useFragmentLighting = 1;
