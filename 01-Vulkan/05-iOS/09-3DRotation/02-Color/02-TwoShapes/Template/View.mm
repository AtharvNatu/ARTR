...
-(void) uninitialize
{
    ...
    if (vertexData_color_cube.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_color_cube.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_color_cube.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_color_cube.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_color_pyramid.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_color_pyramid.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_color_pyramid.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_color_pyramid.vkBuffer\n", __func__);
    }
...
-(VkResult) createVertexBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Color Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Color Buffer For Pyramid\n", __func__);
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Color Buffer For Pyramid : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Color Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Color Buffer For Pyramid\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_color_pyramid.vkBuffer, vertexData_color_pyramid.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Color Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Color Buffer For Pyramid\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_color_pyramid.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Color Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Color Buffer For Pyramid\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Color Buffer For Cube : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Color Buffer For Cube\n", __func__);
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Color Buffer For Cube : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Color Buffer For Cube: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Color Buffer For Cube\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_color_cube.vkBuffer, vertexData_color_cube.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Color Buffer For Cube: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Color Buffer For Cube\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_color_cube.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Color Buffer For Cube: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Color Buffer For Cube\n", __func__);
