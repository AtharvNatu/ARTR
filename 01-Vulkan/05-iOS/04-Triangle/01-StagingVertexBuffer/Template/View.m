...
-(VkResult) createVertexBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed To Create Staging Vertex Buffer: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded In Creating Staging Vertex Buffer\n", __func__);
    ...
    VkBool32 foundMatchingMemoryType_stagingVertex = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        if ((vkMemoryRequirements_stagingBuffer.memoryTypeBits & 1) == 1)
        {
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & (VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT))
            {
                ...
                foundMatchingMemoryType_stagingVertex = VK_TRUE;;;
                break;
            }
        }
    ...
    if (foundMatchingMemoryType_stagingVertex == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible and Host Coherent Memory Not Found For Staging Vertex Buffer : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed To Allocate Memory For Staging Vertex Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded In Allocating Memory For Staging Vertex Buffer\n", __func__);
    ...
    vkResult = vkBindBufferMemory(
        ...
        0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed To Bind Buffer Memory For Staging Vertex Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded In Binding Buffer Memory For Staging Vertex Buffer\n", __func__);
    ...
    vkResult = vkMapMemory(
        ...
        &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed To Map Memory For Staging Vertex Buffer: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded In Mapping Memory For Staging Vertex Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Device-Visible Buffer: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded In Creating Device-Visible Buffer\n", __func__);
    ...
    VkBool32 foundMatchingMemoryType_deviceLocal = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT)
            {
                ...
                foundMatchingMemoryType_deviceLocal = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_deviceLocal == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed To Allocate Memory For Device-Visible Buffer: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded In Allocating Memory For Device-Visible Buffer\n", __func__);

    vkResult = vkBindBufferMemory(vkDevice, vertexData_position.vkBuffer, vertexData_position.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed To Bind Buffer Memory For Device-Visible Buffer: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded In Binding Memory For Device-Visible Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateCommandBuffers() Failed To Allocate Command Buffer For Buffer-Copy: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateCommandBuffers() Succeeded In Allocating Command Buffer For Buffer-Copy\n", __func__);
    //*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBeginCommandBuffer() Failed For Buffer-Copy: %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        if (vkCommandBuffer)
        {
            ...
            printf("%s() => vkFreeCommandBuffers() Succeeded For Buffer-Copy\n", __func__);
        }
        if (vertexData_stagingBuffer_position.vkDeviceMemory)
        {
            ...
            printf("%s() => vkFreeMemory() Succeeded For vertexData_stagingBuffer_position.vkDeviceMemory\n", __func__);
        }
        if (vertexData_stagingBuffer_position.vkBuffer)
        {
            ...
            printf("%s() => vkDestroyBuffer() Succeeded For vertexData_stagingBuffer_position.vkBuffer\n", __func__);
        }

        return vkResult;
    }
    else
        printf("%s() => vkBeginCommandBuffer() Succeeded For Buffer-Copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkEndCommandBuffer() Failed For Buffer-Copy: %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkEndCommandBuffer() Succeeded For Buffer-Copy\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkQueueSubmit() Failed For Buffer-Copy : %d\n", __func__, vkResult);
        ...
        printf("%s() => vkQueueSubmit() Succeeded For Buffer-Copy\n", __func__);

    vkResult = vkQueueWaitIdle(vkQueue);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkQueueWaitIdle() Failed For Buffer-Copy : %d\n", __func__, vkResult);
        ...
        printf("%s() => vkQueueWaitIdle() Succeeded For Buffer-Copy\n", __func__);
    //*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
