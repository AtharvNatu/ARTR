...
-(VkResult) initialize
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createTexture() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createTexture() Succeeded\n", __func__);
...
-(void) uninitialize
{
    ...
    if (vkDescriptorPool)
    {
        ...
        printf("%s() => vkDestroyDescriptorPool() => Destroyed vkDescriptorPool and vkDescriptorSet_straight Successfully\n", __func__);
    }
    ...
    if (uniformData_oblique.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For uniformData_oblique.vkDeviceMemory\n", __func__);
    }
    ...
    if (uniformData_oblique.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For uniformData_oblique.vkBuffer\n", __func__);
    }
    ...
    if (uniformData_straight.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For uniformData_straight.vkDeviceMemory\n", __func__);
    }
    ...
    if (uniformData_straight.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For uniformData_straight.vkBuffer\n", __func__);
    }
...
-(VkResult) createTexture
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateBuffer() Failed For Staging Buffer : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkCreateBuffer() Succeeded For Staging Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For Staging Buffer : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkAllocateMemory() Succeeded For Staging Buffer\n", __func__);

    vkResult = vkBindBufferMemory(vkDevice, vkBuffer_stagingBuffer, vkDeviceMemory_stagingBuffer, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindBufferMemory() Failed For Staging Buffer : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkBindBufferMemory() Succeeded For Staging Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkMapMemory() Failed For Staging Buffer : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkMapMemory() Succeeded For Staging Buffer\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateImage() Failed For Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkCreateImage() Succeeded For Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkAllocateMemory() Succeeded For Texture\n", __func__);

    vkResult = vkBindImageMemory(vkDevice, vkImage_texture, vkDeviceMemory_texture, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindImageMemory() Failed For Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        ...
        printf("%s() => vkBindImageMemory() Succeeded For Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateImageView() Failed For Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkCreateImageView() Succeeded For Texture\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateSampler() Failed For Texture : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => vkCreateSampler() Succeeded For Texture\n", __func__);
...
-(VkResult) createUniformBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateBuffer() Failed For uniformData_straight : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkCreateBuffer() Succeeded For uniformData_straight\n", __func__);
    ...
    VkBool32 foundMatchingMemoryType_uniform_straight = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            {
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_uniform_straight = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_uniform_straight == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For uniformData_straight : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For uniformData_straight : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateMemory() Succeeded For uniformData_straight\n", __func__);

    vkResult = vkBindBufferMemory(vkDevice, uniformData_straight.vkBuffer, uniformData_straight.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindBufferMemory() Failed For uniformData_straight : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkBindBufferMemory() Succeeded For uniformData_straight\n", __func__);
    //! -------------------------------------------------------------------------------------------------------
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateBuffer() Failed For uniformData_oblique : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkCreateBuffer() Succeeded For uniformData_oblique\n", __func__);
    ...
    VkBool32 foundMatchingMemoryType_uniform_oblique = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            {
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_uniform_oblique = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_uniform_oblique == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For uniformData_oblique : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For uniformData_oblique : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateMemory() Succeeded For uniformData_oblique\n", __func__);

    vkResult = vkBindBufferMemory(vkDevice, uniformData_oblique.vkBuffer, uniformData_oblique.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindBufferMemory() Failed For uniformData_oblique : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkBindBufferMemory() Succeeded For uniformData_oblique\n", __func__);
    //! -------------------------------------------------------------------------------------------------------
...
-(VkResult) updateUniformBuffer
{
   ...
   // Code
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkMapMemory() Failed For uniformData_straight : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkMapMemory() Failed For uniformData_oblique : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
...
-(VkResult) createDescriptorSet
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateDescriptorSets() Failed For vkDescriptorSet_straight: %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateDescriptorSets() Succeeded For vkDescriptorSet_straight\n", __func__);
    ...
    */
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateDescriptorSets() Failed For vkDescriptorSet_oblique: %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateDescriptorSets() Succeeded For vkDescriptorSet_oblique\n", __func__);
