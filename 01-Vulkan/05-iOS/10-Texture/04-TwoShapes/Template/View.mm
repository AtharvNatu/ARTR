...
-(VkResult) initialize
{
    ...
    NSString *iconFilePath = [[NSBundle mainBundle] pathForResource:@"Vijay_Kundali" ofType:@"png"];
    const char* textureFileName = [iconFilePath UTF8String];
    vkResult = [self createTexture:textureFileName
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createTexture() Failed For Vijay_Kundali.png : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createTexture() Succeeded For Vijay_Kundali.png\n", __func__);

    //! Create Texture For Pyramid
    iconFilePath = [[NSBundle mainBundle] pathForResource:@"Stone" ofType:@"png"];
    textureFileName = [iconFilePath UTF8String];
    vkResult = [self createTexture:textureFileName
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createTexture() Failed For Stone.png : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createTexture() Succeeded For Stone.png\n", __func__);
...
-(void) uninitialize
{
    ...
    if (vkDescriptorPool)
    {
        ...
        printf("%s() => vkDestroyDescriptorPool() => Destroyed vkDescriptorPool and vkDescriptorSet_cube Successfully\n", __func__);
    }
    ...
    if (vkSampler_texture_cube)
    {
        ...
        printf("%s() => vkDestroySampler() Succeeded For vkSampler_texture_cube\n", __func__);
    }
    ...
    if (vkImageView_texture_cube)
    {
        ...
        printf("%s() => vkDestroyImageView() Succeeded For vkImageView_texture_cube\n", __func__);
    }
    ...
    if (vkDeviceMemory_texture_cube)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vkDeviceMemory_texture_cube\n", __func__);
    }
    ...
    if (vkImage_texture_cube)
    {
        ...
        printf("%s() => vkDestroyImage() Succeeded For vkImage_texture_cube\n", __func__);
    }
    ...
    if (vertexData_texcoord_cube.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_texcoord_cube.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_texcoord_cube.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_texcoord_cube.vkBuffer\n", __func__);
    }
    ...
    if (vkSampler_texture_pyramid)
    {
        ...
        printf("%s() => vkDestroySampler() Succeeded For vkSampler_texture_pyramid\n", __func__);
    }
    ...
    if (vkImageView_texture_pyramid)
    {
        ...
        printf("%s() => vkDestroyImageView() Succeeded For vkImageView_texture_pyramid\n", __func__);
    }
    ...
    if (vkDeviceMemory_texture_pyramid)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vkDeviceMemory_texture_pyramid\n", __func__);
    }
    ...
    if (vkImage_texture_pyramid)
    {
        ...
        printf("%s() => vkDestroyImage() Succeeded For vkImage_texture_pyramid\n", __func__);
    }
    ...
    if (vertexData_texcoord_pyramid.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_texcoord_pyramid.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_texcoord_pyramid.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_texcoord_pyramid.vkBuffer\n", __func__);
    }
...
-(VkResult) createVertexBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Position Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Position Buffer For Pyramid\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_vertex_position_pyramid = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        //* Step - 8.2
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
            {
                //* Step - 8.4
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_position_pyramid = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_position_pyramid == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Position Buffer For Pyramid : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Position Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Position Buffer For Pyramid\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Position Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Position Buffer For Pyramid\n", __func__);

    //* Step - 11
    void* data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position_pyramid.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Position Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Position Buffer For Pyramid\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Texcoord Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Texcoord Buffer For Pyramid\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_vertex_texcoord_pyramid = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        //* Step - 8.2
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
            {
                //* Step - 8.4
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_texcoord_pyramid = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_texcoord_pyramid == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Texcoord Buffer For Pyramid : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Texcoord Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Texcoord Buffer For Pyramid\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoord_pyramid.vkBuffer, vertexData_texcoord_pyramid.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Texcoord Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Texcoord Buffer For Pyramid\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_texcoord_pyramid.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Texcoord Buffer For Pyramid : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Texcoord Buffer For Pyramid\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Position Buffer For Cube : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Position Buffer For Cube\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_vertex_position_cube = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        //* Step - 8.2
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
            {
                //* Step - 8.4
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_position_cube = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_position_cube == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Position Buffer For Cube : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Position Buffer For Cube: %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Position Buffer For Cube\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_position_cube.vkBuffer, vertexData_position_cube.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Position Buffer For Cube : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Position Buffer For Cube\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position_cube.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Position Buffer For Cube : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Position Buffer For Cube\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Texcoord Buffer For Cube : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Texcoord Buffer For Cube\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_vertex_texcoord_cube = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        //* Step - 8.2
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
            {
                //* Step - 8.4
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_texcoord_cube = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_texcoord_cube == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Texcoord Buffer For Cube : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Texcoord Buffer For Cube : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Texcoord Buffer For Cube\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoord_cube.vkBuffer, vertexData_texcoord_cube.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Texcoord Buffer For Cube : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Texcoord Buffer For Cube\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_texcoord_cube.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Texcoord Buffer For Cube : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Texcoord Buffer For Cube\n", __func__);
...
-(VkResult) createUniformBuffer
{
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Pyramid : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateBuffer() Failed For Uniform Data For Cube : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkCreateBuffer() Succeeded For Uniform Data For Cube\n", __func__);
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Cube : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For Uniform Data For Cube : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateMemory() Succeeded For Uniform Data For Cube\n", __func__);

    vkResult = vkBindBufferMemory(vkDevice, uniformData_cube.vkBuffer, uniformData_cube.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindBufferMemory() Failed For Uniform Data For Cube : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Uniform Data For Cube\n", __func__);
    //! -------------------------------------------------------------------------------------------------------------------------------
