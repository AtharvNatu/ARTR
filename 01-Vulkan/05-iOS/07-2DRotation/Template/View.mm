...
-(VkResult) initialize
{
    ...
    vkResult = [self createPipeline:&vkPipeline_triangle :VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST];
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createPipeline() Failed For Triangle : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createPipeline() Succeeded For Triangle\n", __func__);

    //! Create Pipeline For Rectangle
    vkResult = [self createPipeline:&vkPipeline_rectangle :VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST];
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createPipeline() Failed For Rectangle : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createPipeline() Succeeded For Rectangle\n", __func__);
...
-(void) uninitialize
{
    ...
    if (vkPipeline_rectangle)
    {
        vkDestroyPipeline(vkDevice, vkPipeline_rectangle, NULL);
        vkPipeline_rectangle = VK_NULL_HANDLE;
        printf("%s() => vkDestroyPipeline() Succeeded For Rectangle\n", __func__);
    }
    ...
    if (vkPipeline_triangle)
    {
        vkDestroyPipeline(vkDevice, vkPipeline_triangle, NULL);
        vkPipeline_triangle = VK_NULL_HANDLE;
        printf("%s() => vkDestroyPipeline() Succeeded For Triangle\n", __func__);
    }
    ...
    if (vkDescriptorPool)
    {
        ...
        printf("%s() => vkDestroyDescriptorPool() => Destroyed vkDescriptorPool and vkDescriptorSet_triangle Successfully\n", __func__);
    }
    ...
    if (uniformData_rectangle.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For uniformData_rectangle.vkDeviceMemory\n", __func__);
    }
    ...
    if (uniformData_rectangle.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For uniformData_rectangle.vkBuffer\n", __func__);
    }
    ...
    if (uniformData_triangle.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For uniformData_triangle.vkDeviceMemory\n", __func__);
    }
    ...
    if (uniformData_triangle.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For uniformData_triangle.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_color_rectangle.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_color_rectangle.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_color_rectangle.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_color_rectangle.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_position_rectangle.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_position_rectangle.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_position_rectangle.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_position_rectangle.vkBuffer\n", __func__);
    }
    //! ------------------------------------------------------------------------------------------------------------
    ...
    if (vertexData_color_triangle.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_color_triangle.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_color_triangle.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_color_triangle.vkBuffer\n", __func__);
    }
    ...
    if (vertexData_position_triangle.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_position_triangle.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_position_triangle.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_position_triangle.vkBuffer\n", __func__);
    }
    //! ------------------------------------------------------------------------------------------------------------
...
-(VkResult) createVertexBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Position Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Position Buffer Used For Triangle\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_vertex_triangle_position = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        ...
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
            {
                ...
                foundMatchingMemoryType_vertex_triangle_position = VK_TRUE;
                break;
            }
        }
    ...
    if (foundMatchingMemoryType_vertex_triangle_position == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Position Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Position Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Position Buffer Used For Triangle\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Position Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Position Buffer Used For Triangle\n", __func__);

    //* Step - 11
    void* data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position_triangle.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Position Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Position Buffer Used For Triangle\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Color Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Color Buffer Used For Triangle\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_vertex_triangle_color = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        //* Step - 8.2
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
            {
                //* Step - 8.4
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_triangle_color = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_triangle_color == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Color Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Color Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Color Buffer Used For Triangle\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_color_triangle.vkBuffer, vertexData_color_triangle.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Color Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Color Buffer Used For Triangle\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_color_triangle.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Color Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Color Buffer Used For Triangle\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Position Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Position Buffer Used For Rectangle\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_vertex_rectangle_position = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        //* Step - 8.2
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
            {
                //* Step - 8.4
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_rectangle_position = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_rectangle_position == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Position Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Position Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Position Buffer Used For Rectangle\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Position Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Position Buffer Used For Rectangle\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position_rectangle.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Position Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Position Buffer Used For Rectangle\n", __func__);
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Vertex Color Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Vertex Color Buffer Used For Rectangle\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_vertex_rectangle_color = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        //* Step - 8.2
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
            {
                //* Step - 8.4
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_vertex_rectangle_color = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_vertex_rectangle_color == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Vertex Color Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Vertex Color Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Vertex Color Buffer Used For Rectangle\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_color_rectangle.vkBuffer, vertexData_color_rectangle.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Vertex Color Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Vertex Color Buffer Used For Rectangle\n", __func__);

    //* Step - 11
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_color_rectangle.vkDeviceMemory, 0, vkMemoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For Vertex Color Buffer Used For Rectangle : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkMapMemory() Succeeded For Vertex Color Buffer Used For Rectangle\n", __func__);
...
-(VkResult) createUniformBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateBuffer() Failed For Uniform Data Used For Triangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkCreateBuffer() Succeeded For Uniform Data Used For Triangle\n", __func__);
    ...
    VkBool32 foundMatchingMemoryType_uniform_triangle = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            {
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_uniform_triangle = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_uniform_triangle == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Triangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For Uniform Data Used For Triangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateMemory() Succeeded For Uniform Data Used For Triangle\n", __func__);

    vkResult = vkBindBufferMemory(vkDevice, uniformData_triangle.vkBuffer, uniformData_triangle.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindBufferMemory() Failed For Uniform Data Used For Triangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Uniform Data Used For Triangle\n", __func__);
    //! ------------------------------------------------------------------------------------------------------------
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkCreateBuffer() Failed For Uniform Data Used For Rectangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkCreateBuffer() Succeeded For Uniform Data Used For Rectangle\n", __func__);
    ...
    VkBool32 foundMatchingMemoryType_uniform_rectangle = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            {
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_uniform_rectangle = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_uniform_rectangle == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible Memory Not Found For Rectangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateMemory() Failed For Uniform Data Used For Rectangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateMemory() Succeeded For Uniform Data Used For Rectangle\n", __func__);

    vkResult = vkBindBufferMemory(vkDevice, uniformData_rectangle.vkBuffer, uniformData_rectangle.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBindBufferMemory() Failed For Uniform Data Used For Rectangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Uniform Data Used For Rectangle\n", __func__);
    //! ------------------------------------------------------------------------------------------------------------
...
-(VkResult) updateUniformBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkMapMemory() Failed For Uniform Buffer Used For Triangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
...
-(VkResult) createDescriptorSet
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateDescriptorSets() Failed For Triangle : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateDescriptorSets() Succeeded For Triangle\n", __func__);
    ...
    */
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateDescriptorSets() Failed For Rectangle: %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateDescriptorSets() Succeeded For Rectangle\n", __func__);
