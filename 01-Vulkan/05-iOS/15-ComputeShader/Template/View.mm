...
uint32_t meshWidth = 64;
uint32_t meshHeight = 64;
...
-(VkResult) initialize
{
    ...
    pPosition = (float*)malloc(MAX_MESH_SIZE * sizeof(float));
    if (pPosition == NULL)
    {
        printf("%s() => malloc() Failed For pPosition : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }

    memset(pPosition, 0, MAX_MESH_SIZE * sizeof(float));
    ...
    vkResult = [self createIndirectBuffer];
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => createIndirectBuffer() Failed : %d !!!\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => createIndirectBuffer() Succeeded\n", __func__);
    ...
    vkResult = [self initialize_compute];
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => initialize_compute() Failed\n", __func__);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    else
        printf("%s() => initialize_compute() Succeeded\n", __func__);
...
-(VkResult) render
{
    ...
    if (bUseCompute)
    {
        [self buildCommandBuffer_compute];
    ...
    {
        //! Create Sinewave
        [self sinewave:meshWidth :meshHeight :fAnimationSpeed];
        
        //! Update Vertex Buffer
        vkResult = [self updateVertexBuffer];
        if (vkResult != VK_SUCCESS)
            printf("%s() => updateVertexBuffer() Failed : %d\n", __func__, vkResult);
    }

    vkResult = [self updateIndirectBuffer];
    if (vkResult != VK_SUCCESS)
...
{
    // Code
    fAnimationSpeed = fAnimationSpeed + 0.15f;
}
...
-(void) uninitialize
{
    ...
    if (vertexData_indirect_buffer.vkDeviceMemory)
    {
        ...
        printf("%s() => vkFreeMemory() Succeeded For vertexData_indirect_buffer.vkDeviceMemory\n", __func__);
    }
    ...
    if (vertexData_indirect_buffer.vkBuffer)
    {
        ...
        printf("%s() => vkDestroyBuffer() Succeeded For vertexData_indirect_buffer.vkBuffer\n", __func__);
    }
...
-(VkResult) createVertexBuffer
{
    ...
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => ReBAR Memory Not Found : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
...
-(VkResult) updateVertexBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For vertexData_position : %d\n", __func__, vkResult);
...
-(VkResult) createIndirectBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateBuffer() Failed For Indirect Buffer  : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateBuffer() Succeeded For Indirect Buffer\n", __func__);
    ...
    //* Step - 8.1
    VkBool32 foundMatchingMemoryType_indirect = VK_FALSE;
    for (uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        //* Step - 8.2
        if ((vkMemoryRequirements.memoryTypeBits & 1) == 1)
        {
            ...
            if (vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & (VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT))
            {
                //* Step - 8.4
                vkMemoryAllocateInfo.memoryTypeIndex = i;
                foundMatchingMemoryType_indirect = VK_TRUE;
                break;
            }
        }
    ...
    //* Check For memoryTypeIndex != 0 On MoltenVK
    if (foundMatchingMemoryType_indirect == VK_FALSE)
    {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        printf("%s() => Host Visible | Host Coherent Memory Not Found : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateMemory() Failed For Indirect Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateMemory() Succeeded For Indirect Buffer\n", __func__);

    //* Step - 10
    //! Binds Vulkan Device Memory Object Handle with the Vulkan Buffer Object Handle
    vkResult = vkBindBufferMemory(vkDevice, vertexData_indirect_buffer.vkBuffer, vertexData_indirect_buffer.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkBindBufferMemory() Failed For Indirect Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkBindBufferMemory() Succeeded For Indirect Buffer\n", __func__);

    vkResult = [self updateIndirectBuffer];
    if (vkResult != VK_SUCCESS)
        printf("%s() => updateIndirectBuffer() Failed For Vertex Position Buffer : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => updateIndirectBuffer() Succeeded For Vertex Position Buffer\n", __func__);
...
-(VkResult) updateIndirectBuffer
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkMapMemory() Failed For vertexData_indirect_buffer : %d !!!\n", __func__, vkResult);
...
-(VkResult) initialize_compute
{
    ...
    // Code
    vkResult = [self createCommandBuffer_compute];
    if (vkResult != VK_SUCCESS)
        printf("%s() => createCommandBuffer_compute() Failed : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => createCommandBuffer_compute() Succeeded\n", __func__);

    vkResult = [self createShader_compute];
    if (vkResult != VK_SUCCESS)
        printf("%s() => createShader_compute() Failed : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => createShader_compute() Succeeded\n", __func__);

    vkResult = [self createDescriptorSetLayout_compute];
    if (vkResult != VK_SUCCESS)
        printf("%s() => createDescriptorSetLayout_compute() Failed : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => createDescriptorSetLayout_compute() Succeeded\n", __func__);

    vkResult = [self createPipelineLayout_compute];
    if (vkResult != VK_SUCCESS)
        printf("%s() => createPipelineLayout_compute() Failed : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => createPipelineLayout_compute() Succeeded\n", __func__);

    vkResult = [self createDescriptorSet_compute];
    if (vkResult != VK_SUCCESS)
        printf("%s() => createDescriptorSet_compute() Failed : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => createDescriptorSet_compute() Succeeded\n", __func__);

    vkResult = [self createPipeline_compute];
    if (vkResult != VK_SUCCESS)
        printf("%s() => createPipeline_compute() Failed : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => createPipeline_compute() Succeeded\n", __func__);

    vkResult = [self buildCommandBuffer_compute];
    if (vkResult != VK_SUCCESS)
        printf("%s() => buildCommandBuffer_compute() Failed : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => buildCommandBuffer_compute() Succeeded\n", __func__);
...
-(VkResult) createCommandBuffer_compute
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkAllocateCommandBuffers() Failed For vkCommandBuffer_compute : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkAllocateCommandBuffers() Succeeded For vkCommandBuffer_compute\n", __func__);
...
-(VkResult) createShader_compute
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateShaderModule() Failed For Compute Shader : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateShaderModule() Succeeded For Compute Shader\n", __func__);
    ...
    printf("%s() => Compute Shader Module Successfully Created\n", __func__);
    //! -----------------------------------------------------------------------------------------------------------------------
...
-(VkResult) createDescriptorSetLayout_compute
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateDescriptorSetLayout() Failed For Compute : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateDescriptorSetLayout() Succeeded For Compute\n", __func__);
...
-(VkResult) createPipelineLayout_compute
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreatePipelineLayout() Failed For Compute : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreatePipelineLayout() Succeeded For Compute\n", __func__);
...
-(VkResult) createDescriptorSet_compute
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkAllocateDescriptorSets() Failed For vkDescriptorSet_compute : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
    else
        printf("%s() => vkAllocateDescriptorSets() Succeeded For vkDescriptorSet_compute\n", __func__);
...
-(VkResult) createPipeline_compute
{
    ...
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreatePipelineCache() Failed For Compute : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreatePipelineCache() Succeeded For Compute\n", __func__);
    
    vkResult = vkCreateComputePipelines(vkDevice, vkPipelineCache_compute, 1, &vkComputePipelineCreateInfo, NULL, &vkPipeline_compute);
    if (vkResult != VK_SUCCESS)
        printf("%s() => vkCreateComputePipelines() Failed : %d !!!\n", __func__, vkResult);
    else
        printf("%s() => vkCreateComputePipelines() Succeeded\n", __func__);
...
-(VkResult) buildCommandBuffer_compute
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkResetCommandBuffer() Failed : %d\n", __func__, vkResult);
        return VK_ERROR_INITIALIZATION_FAILED;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkBeginCommandBuffer() Failed For vkCommandBuffer_compute : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        printf("%s() => vkEndCommandBuffer() Failed For vkCommandBuffer_compute : %d\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return vkResult;
    }
