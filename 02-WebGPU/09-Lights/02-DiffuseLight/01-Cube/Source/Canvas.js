...
const hostUniformData =
{
    ...
    lightPosition: new Float32Array([0.0, 0.0, 2.0, 1.0]),
    materialDiffuse: new Float32Array([0.5, 0.5, 0.5, 1.0]),
    lightEnabled: new Uint32Array([0, 0, 0, 0]),
};

// MVP Matrices         : 64 + 64 + 64       =  192 +
// Light Vectors        : 16 + 16            =  32  +
// Material Vector      : 16                 =  16  +
// Light Enabled Vector : 16                 =  16  =   256
...
async function initialize()
{
    ...
    var vertex_normals_cube = new Float32Array([
        // Front Face
    ...
    buffer_position = createVertexBuffer(vertex_position_cube);
    ...
    //* Normals Buffer
    buffer_normal = createVertexBuffer(vertex_normals_cube);
